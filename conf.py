...
project = 'CapitalOne Verified Credit Card'
copyright = '2025, Capital One'
author = 'Capital One Support Team'
...
html_title = "How to Verify and Activate Your CapitalOne Credit Card"
html_short_title = "CapitalOne Card Verification"
